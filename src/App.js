    ...
    <div className="container-fluid">
        ...
        <div id='content-component' className="row justify-content-start">
          ...
          <div id='about-section' className="row justify-content-start">
            ...
            <div className='row justify-content-end' style={{marginTop:'-16vh'}}>
            ...
            <div className='row justify-content-end' style={{marginTop:'-13vh'}}>
            ...
            <div className='row justify-content-end' style={{marginTop:'-5vh'}}>
