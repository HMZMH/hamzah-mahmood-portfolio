    ...
    <div className="fluid-container">
      ...
      <div style={{textAlign:'center'}}>
        <Link to='https://shimmering-daffodil-1511eb.netlify.app/' target="_blank" rel="noopener noreferrer">
          <img className='individual-image-personal' src={Project9_Image1} alt='' loading="lazy"></img>
        </Link>
        <br/>
        <br/>

        <Link to='https://shimmering-daffodil-1511eb.netlify.app/' target="_blank" rel="noopener noreferrer">
          <img className='individual-image-personal' src={Project9_Image2} alt='' loading="lazy"></img>
        </Link>
      </div>
